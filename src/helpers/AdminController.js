...
export const createMenu = (name, slug, icon, order, role_id, access_token) => {
    return Promise.race([
        new Promise((resolve, reject) => {
...
export const updateMenu = (menu_id, name, slug, icon, order, role_id, access_token) => {
    return Promise.race([
        new Promise((resolve, reject) => {
...
export const createSubMenu = (menu_id, name, slug, icon, order, role_id, access_token) => {
    return Promise.race([
        new Promise((resolve, reject) => {
...
export const updateSubMenu = (submenu_id, menu_id, name, slug, icon, order, role_id, access_token) => {
    return Promise.race([
        new Promise((resolve, reject) => {
...
export const getUser = (access_token) => {
    return Promise.race([
        new Promise((resolve, reject) => {
            fetch(global.URL + 'api/admin/user/get', {
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
...
export const resetPasswordUser = (current_password, password, password_confirmation, access_token) => {
    return Promise.race([
        new Promise((resolve, reject) => {
            fetch(global.URL + 'api/admin/user/reset/password', {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
